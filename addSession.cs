    ...
    partial class addSession : Smobiler.Core.Controls.MobileUserControl
    {
        ...
        private void button1_Press(object sender, EventArgs e)
        {
            ...
            string select = "select * from Projection,Movie where Movie.Mno=Projection.Mno and Cno='" + Cno + "'and Phall="
                + gethall.Text.Substring(0, 1) + "and Ptime <= '" + Pdate + " " + datePicker1.BindDisplayValue +
                 "'and Ptime >'" + Pdate + " " + "00:00:00'" +
                "'and date_add(Ptime,interval Mduration minute)>'" + Pdate + " " + datePicker1.BindDisplayValue + "';";//判断是否存在同一影院同一放映厅同一时间的电影
            ...
            {
                string time = Pdate + datePicker1.BindDisplayValue.ToString();
